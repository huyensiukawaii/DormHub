...
import {
  ...
  Building2, Home, FileText, Wrench, Loader2,
} from 'lucide-react';
    ...
    <div className="min-h-screen flex bg-white">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-[420px]">
          ...
          {/* Error Message Box */}
          {error && (
            <div className="mb-6 flex items-center gap-2.5 bg-red-50 border border-red-100 text-red-600 text-sm px-4 py-3.5 rounded-lg">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all placeholder:text-slate-400"
                />
                <button
                  type="button"
